...
namespace EmployeeBackend.Repository
{
    internal class EmployeeRepo : IEmployeeRepo
    {
        ...
        {
            Employee emp = _context.Employees.Where(x => x.Id.ToString() == Id).FirstOrDefault();
            return emp;
        }
        ...
        public Employee PostEmployee(EmployeeRequestDto Dto)
        {
        ...
        {
            Employee newObj = _context.Employees.Where(x => x.Id == Dto.Id).FirstOrDefault();
            if (newObj != null)
            {
        ...
        {
            Employee newObj = _context.Employees.Where(x => x.Id.ToString() == Id).FirstOrDefault();
            if (newObj != null)
            {
