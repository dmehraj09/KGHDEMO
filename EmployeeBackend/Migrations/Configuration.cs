namespace EmployeeBackend.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<EmployeeBackend.Models.EmployeeContext>
    {
        ...
        protected override void Seed(EmployeeBackend.Models.EmployeeContext context)
        {
