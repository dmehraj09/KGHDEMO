...
export class EmployeeRequestDto {
    ...
    public constructor(init?: Partial<EmployeeRequestDto>) { (Object as any).assign(this, init); }
    public createResponse() { return new EmployeeResonseDto(); }
    public getTypeName() { return 'EmployeeRequestDto'; }
